...
#
# # Decision Tree 분류기 정의 및 학습
# from sklearn.tree import DecisionTreeClassifier
# from sklearn import metrics
#
# dt = DecisionTreeClassifier(max_depth=15)
# dt.fit(train_features, y_train.ravel())
#
# # 테스트 데이터로 예측 수행
...
# print(f"Decision Tree 테스트 정확도: {test_acc:.3f}")
#
# # 혼동 행렬 생성 및 시각화
...
dt = DecisionTreeClassifier(max_depth=15)
dt.fit(train_features, y_train.flatten())
...
# 정확도 계산
test_acc = metrics.accuracy_score(y_test, predicted_labels)
print(f"Decision Tree 테스트 정확도: {test_acc}")
